...
<head runat="server">
    <title>How to Select All Values from Asp.Net Text Box And Display Using Jquery</title>
...
<body>
    <nav class="navbar navbar-expand-sm badge-success bg-inverse justify-content-center text-uppercase">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white" href="AllTextBoxValues.aspx">Get All Asp.net TextBox Values Using Jquery</a>
            </li>
        </ul>
    </nav>
    <div class="row m-0">
